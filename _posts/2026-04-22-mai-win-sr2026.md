...
There were two types of samples: acidoc and basic, and the teams earned points for having only one kind of sample in their laboratory, since having one of each type would cancel each other out.
